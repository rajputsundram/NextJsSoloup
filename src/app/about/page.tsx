    ...
    return (
        ...
        <div className="mt-[53rem] sm:mt-80 flex h-full   w-full flex-wrap sm:h-[36rem] ">
            ...
            <div className="flex flex-col   mx-0 px-0 w-full  sm:w-[55%] items-start">
                <h2 className="sm:ml-24 ml-7  text-blue-600 text-xl font-bold">About us</h2>
                <h1 className="sm:ml-24 ml-7 mt-3 scale-200 font-mono font-bold text-blue-950 sm:text-5xl text-3xl  ">The Best IT Solution With 10 Years of Experience</h1>
                ...
                <div className="sm:ml-20 ml-7  font-bold text-xl">
                    <div className="flex-col ml-7 sm:gap-48 flex sm:flex-row  ">
                        <div className="flex  my-3"><IoMdCheckmark className="text-blue-700 text-3xl font-bold"/>  <p className="">Award Winning</p></div>

                        <div className="flex my-3"><IoMdCheckmark className="text-blue-700 text-3xl font-extrabold"/>  <p className="">24/7 Support</p></div>
                    </div>

                    <div className="flex-col flex ml-7  sm:gap-48 sm:flex-row ">
                        <div className="flex my-3">   <IoMdCheckmark className="text-blue-700 text-3xl font-extrabold" />  <p className="">Professional Staff</p></div>
