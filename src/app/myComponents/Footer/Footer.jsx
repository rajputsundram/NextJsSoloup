...
const Footer=()=>{
    ...
    <div className="mt-20 w-full flex sm:flex-row flex-col bg-black h-full sm:mt-5 ">
        ...
        <div className="flex justify-center items-center p-3 flex-col h-[500px] bg-blue-500 ml-1 sm:ml-40 w-full sm:w-[30%]">
            <div className="font-bold text-white text-3xl ">SOLOUP</div>
                <span className="text-lg text-white">Lorem ipsum dolor sit amet consectetur adipisicing elit. Vero ullam ipsam sequi quam magnam voluptas voluptates maiores eligendi dignissimos omnis, quod, velit aspernatur. c</span>
        ...
        <div className="bg-black w-full sm:w-[20%] p-[30px]">
            ...
            <div className="flex h-[25px]  items-center justify-start font-[18px] mt-5 "><span className="text-blue-400"><CiLocationOn /></span><p className='text-white ml-2'>123,Noida City, India</p></div>
    ...
    <div className="h-[40px] flex justify-center items-center w-full bg-black text-white ">
